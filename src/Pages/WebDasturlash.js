...
const showToast2 = ()=>{
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={w1} className="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
    <div className="carousel-item">
      <img src={w2} className="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
    <div className="carousel-item">
      <img src={w3} className="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
  </div>
...
<div className="accordion accordion-flush" id="accordionFlushExample">
  ...
  <div className="accordion-item">
    ...
    <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body">Ushbu kursning narxi 500ming so'm bo'lib,  to'lov har oyning 10 sanasigacha to'laniladi<br/><strong>BIRINCHI DARS BEPUL!!!</strong></div>
    </div>
  </div>
  <div className="accordion-item">
    ...
    <div id="flush-collapseThree" className="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body">Ushbu kurs davomiyligi 10 oy va ushbu muddat o'tgandan so'ng 2 oy davomida amaliyot o'tash jarayoni boshlanadi.</div>
    </div>
  </div>
</div>
</div>
