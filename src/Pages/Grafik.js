...
const showToast2 = ()=>{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src={g1} class="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
    <div class="carousel-item">
      <img src={g2} class="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
    <div class="carousel-item">
      <img src={g3} class="d-block w-100" style={{height:"75vh"}} alt="..." />
    </div>
  </div>
