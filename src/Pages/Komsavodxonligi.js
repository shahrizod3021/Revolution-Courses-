...
const showToast2 = ()=>{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src={s1} class="d-block w-100" style={{height:"75vh"}} alt="savodxonlig" />
    </div>
    <div class="carousel-item">
      <img src={s2} class="d-block w-100" style={{height:"75vh"}} alt="savodxonlig" />
    </div>
    <div class="carousel-item">
      <img src={s3} class="d-block w-100" style={{height:"75vh"}} alt="savodxonlig" />
    </div>
  </div>
